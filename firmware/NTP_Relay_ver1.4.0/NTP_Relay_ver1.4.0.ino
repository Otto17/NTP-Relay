/*
  ...
  Изменения:
  - Начальный релиз (Версия: 1.3, Дата создания: 01.04.2023г.)
  - Обновил библиотеки и плату ESP8266 до версии 3.1.2 (Версия: 1.3.1, Дата создания: 10.06.2023г.)
  - Добавил датчик температуры DS18B20 с выводом температуры в комнате и возможностью калибровки температуры перед прошивкой (Версия: 1.4.0, Дата создания: 11.06.2023г.)


  Дата создания: 11.06.2023г.
  Версия: 1.4.0
  Автор: Otto.
